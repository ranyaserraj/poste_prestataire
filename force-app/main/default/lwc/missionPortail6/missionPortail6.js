...
import getMissions            from '@salesforce/apex/MissionPortailController6.getMissions';
import getMissionRecordTypeId from '@salesforce/apex/MissionPortailController6.getMissionRecordTypeId';
import getStatutOptions       from '@salesforce/apex/MissionPortailController6.getStatutOptions';
import getBrancheOptions      from '@salesforce/apex/MissionPortailController6.getBrancheOptions';
...
export default class MissionPortail6 extends NavigationMixin(LightningElement) {

    /* ── PROPS ── */
    // ✅ MODE ACCOUNT (Record Page) — ACTIF
    @api recordId;

    // ✅ MODE PORTAIL (Experience Cloud) — commenter si recordId utilisé
    ...
    // ✅ MODE ACCOUNT — commenter pour le portail
    // @wire(getMissions, { accountId: '$recordId' })
    ...
    /* ── MODE TEST ── */
    connectedCallback() {
        // ✅ MODE ACCOUNT — décommenter si pas de recordId en Record Page
        // if (!this.recordId) { this._loadTestMissions(); }
    ...
    _loadTestMissions() {
        ...
        this._buildFallbackStatuts();
        this._buildFallbackBranches();
        console.log('Filtres construits —', this.statutOptions, this.brancheOptions);
    }
    ...
    _buildFallbackStatuts() {
        ...
        console.log('Filtres STATUT construits :', this.statutOptions);
    }
    ...
    _buildFallbackBranches() {
        ...
        console.log('Filtres BRANCHE construits :', this.brancheOptions);
    }
    ...
    /* ── HANDLERS ── */
    handleNew() { alert('Créer une nouvelle mission'); }
